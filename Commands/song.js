    ...
    try {
        ...
        try {
            sentMsg = await sock.sendMessage(chatId, {
                ...
                caption: `*${result.result.title}*\n\n> _Downloading your song..._\n > *_By https://telebotdev.blogspot.com \n\n by https://osunhive.blogspot.com_*`
            }, { quoted: message });
        } catch (e) {
        ...
        await sock.sendMessage(chatId, { text: "Download failed. Please try again later. check our my website for documentation..https:osunhive.name.ng" });
    }
}
